...
public final class CarLabeler extends AppCompatActivity
  ...
  private static final String IMAGE_LABELING_CUSTOM = "Custom Image Labeling (Cars)";
  ...
  private void bindAnalysisUseCase() {
    ...
    try {
      Log.i(TAG, "Using Custom Image Label (Cars) Detector Processor");
      LocalModel localClassifier =
              new LocalModel.Builder()
                      .setAssetFilePath("custom_model/model.tflite")
                      .build();
